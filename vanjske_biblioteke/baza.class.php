...
class Baza
{
    ...
    const korisnik = "root";
    const lozinka = "";
    const baza = "webdip2019x135";*/

    const server = "localhost";
    const korisnik = "WebDiP2019x135";
    const lozinka = "admin_rIZU";
    const baza = "WebDiP2019x135";
    private $veza = null;
    private $greska = '';
    ...
    {
        $result = mysqli_query($this->veza, $query);
        if (!$result) {
            die('Invalid query: ' . mysqli_error($this->veza));
        } else {
